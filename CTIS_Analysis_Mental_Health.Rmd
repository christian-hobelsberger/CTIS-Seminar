...
ggplot(data = table_Obs_E4_Date, mapping = aes(x = RecordedDate, y = count)) +
  geom_line() +
  labs(title = "Observations E4 (nervous) vs RecordedDate",
...
ggplot(table_D1_D7a_WO_NA, aes(x = D1, y = perc)) + geom_bar(stat = "identity") +s
  facet_wrap(~D7a) +
  coord_flip() +
  labs(title = "D1 (nervous) vs D7a (work last 4 weeks)", 
       y = "relative frequencies",
       x = "D1 (nervous)")
ggsave("Plots/Chris/table_data/NO_NA_D1_vs_D7a_barplot.png", width = 12, height = 9)
...
ggsave("Plots/Chris/table_data/D1_vs_D7a_dodge_barplot.png", width = 12, height = 9)
...
ggsave("Plots/Chris/table_data/NO_NA_D1_vs_D7a_dodge_barplot.png", width = 12, height = 9)
...
```{r}
plot_global_map(data_CTIS_map, variable = "anxious_7d",survey_date = "2021-01-28", mode = "plot", 
                id = "data.country", 
                popup.vars = c("Anxiety last 7 days:" = "anxious_7d", 
                               "Stay home req. level" = "stay_home_requirements", "School closure level" = "school_closures"))
