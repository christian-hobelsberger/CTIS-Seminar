...
names_sufficient_data = names(which(table(data_aggregated$data.country) >= 600))
names_sufficient_data

# Get the 10 countries with the highest amount of observations
names(sort(table(data_aggregated$data.country), decreasing = TRUE)[1:10])
