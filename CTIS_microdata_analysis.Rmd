...
CTIS_microdata <- readRDS("data/protected_data/CTIS_microdata_cleanV4.RDS")
...
# Arranged plots ------------------------------------------------------------------
# Plot: D1 (anxious)
D1_barplot <- ggplot(table_D1, aes(x = D1, y = perc)) + geom_bar(stat = "identity") +
  labs(title = "D1 (anxious)", 
       y = "relative frequencies")
NO_NA_D1_barplot <- ggplot(table_D1_WO_NA, aes(x = D1, y = perc)) + geom_bar(stat = "identity") +
  labs(title = "D1 (anxious) - no NAs", 
       y = "relative frequencies")
ggarrange(D1_barplot, NO_NA_D1_barplot, ncol = 2, nrow = 1)
ggsave("Plots/Chris/table_data/aggregated_D1.png", width = 12, height = 9)
...
#   facet_wrap(~E4) +
#   coord_flip() +
#   labs(title = "D1 (anxious) vs E4 (Age)")
