...
```{r}
CTIS_micro <- readRDS("~/CTIS-Seminar/data/protected_data/CTIS_microdata_cleanV4.RDS")
```
...
model_1.1 <- glm(worried ~ factor(E3 , ordered = FALSE ) + factor(E4 , ordered = FALSE ) + 
                   factor(E2 , ordered = FALSE ) + factor(V11 , ordered = FALSE ) + factor(E8 , ordered = FALSE ), 
                 family=binomial(link='logit'), data=CTIS_micro)
summary(model_1.1)
...
model_4 <- glm(worried ~ E4 + E8 + E3 + D7a ,family=binomial(link='logit'), data=CTIS_micro)
model_5 <- glm(worried ~ factor(E4 , ordered = FALSE ) + factor(E8 , ordered = FALSE ) + factor(E3 , ordered = FALSE ) +
                 factor(D7a , ordered = FALSE ) ,family=binomial(link='logit'), data=CTIS_micro)
summary(model_4)
summary(model_5)
```
