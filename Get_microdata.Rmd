...
CTIS_microdata_v5 <- left_join(CTIS_microdata, country_map, by = c("A2_2_1" = "country_region_numeric"))


saveRDS(object = CTIS_microdata, file = "data/protected_data/CTIS_microdata_cleanV5.RDS")
```
